var positionsData = [
   ...
   {
      "element-name":"teste-teste-123",
      "display-name":"Teste, Teste, 1, 2, 3",
      "svg-name":"TesteTeste123.svg",
      "orientation":"vertical",
   ...
   },
   {
	...
	{
		"element-name":"studdy-buddy",
		"display-name":"Study Buddy",
		"svg-name":"StuddyBuddy.svg",
		"orientation":"vertical",
		"cancer-type":"breast",
		"display-cancer-type":"Breast Cancer",
	...
	},
	{
		...
		"element-name":"probe-officer",
		"display-name":"Probe Officer",
		"svg-name":"",
		"orientation":"",
		"cancer-type":"prostate",
		"display-cancer-type":"Prostate Cancer",
		"detail-html":"<p>If there's one thing that holds true in every relationship, it's that a little lip service never goes missed.</p><p>Start by lying on your back, and bringing your partner's hips to your lips. As you find out how many licks it takes to get to the center of his universe, bring one hand up and let it find its way to glory, making sure to keep your digit pointed toward his groin.*</p>",
		"just-the-tip":"Not sure you've made it yet? Never you worry: He'll let you know when you've arrived at the Promised Gland.",
		"full-width":false,
      	"overview-index":0,
     	"chapter-index":0
	},
